...
export const themeOne: CustomThemeConfig = {
	name: 'themeOne',
	properties: {
		// =~= Theme Properties =~=
		...
		// surface | #3F4F54
		'--color-surface-50': '226 229 229', // #e2e5e5
		'--color-surface-100': '217 220 221', // #d9dcdd
		'--color-surface-200': '207 211 212', // #cfd3d4
		'--color-surface-300': '178 185 187', // #b2b9bb
		'--color-surface-400': '121 132 135', // #798487
		'--color-surface-500': '63 79 84', // #3F4F54
		'--color-surface-600': '57 71 76', // #39474c
		'--color-surface-700': '47 59 63', // #2f3b3f
		'--color-surface-800': '38 47 50', // #262f32
		'--color-surface-900': '31 39 41' // #1f2729
	}
};
